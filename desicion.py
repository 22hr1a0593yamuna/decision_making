...
best_lab = None
max_capacity = 0
if capacity_L1 >= number_of_students and capacity_L1 > max_capacity:
    best_lab = "L1"
    max_capacity = capacity_L1
if capacity_L2 >= number_of_students and capacity_L2 > max_capacity:
    best_lab = "L2"
    max_capacity = capacity_L2
if capacity_L3 >= number_of_students and capacity_L3 > max_capacity:
    best_lab = "L3"
